-- Complete Daily Verses Setup
-- This script creates the daily_verses table and populates it with sample data
-- Run this script to set up the daily feature with database integration

-- ==============================================
-- 1. CREATE DAILY VERSES TABLE
-- ==============================================
...
-- Function to get daily verse by date
...
-- Function to get daily verse by day of year (for cycling through verses)
...
-- Function to get the next available daily verse
...
SELECT 'Testing get_daily_verse_by_date function...' as test;
SELECT verse_id, chapter_index, verse_index FROM get_daily_verse_by_date('2025-10-27');

SELECT 'Testing get_daily_verse_by_day_of_year function...' as test;
SELECT verse_id, chapter_index, verse_index FROM get_daily_verse_by_day_of_year(300);

SELECT 'Testing get_next_daily_verse function...' as test;
SELECT verse_id, chapter_index, verse_index FROM get_next_daily_verse();

-- ==============================================
-- 5. COMPLETION MESSAGE
-- ==============================================

SELECT 'Daily verses setup completed successfully!' as message,
       'The daily feature is now ready to use with database integration.' as description;
